...
@section('content')
    <section style="margin-top: 100px">
        <div class="container col-xxl-8 py-5">
            <h3 class="fw-bold mb-2">Halaman Photo Kegiatan</h3>
            ...
            @if (count($errors) > 0)
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    ...
                    <button type="button" value="btn btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            @endif
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('photo.update', $item->id) }}" method="POST"
                                                ...
                                                <input type="hidden" name="id_photo" id="{{ $item->id }}">
